      ...
      <div className="container relative pt-16 pb-24 md:pt-24 md:pb-32 grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
        <div className="animate-fade-up">
          ...
          <div className="mt-10">
            <Link
              to="/quiz"
              className="inline-flex items-center gap-2 px-7 py-4 rounded-full bg-white font-bold shadow-soft hover:bg-secondary transition-colors"
            >
              Take the quiz
            </Link>
          </div>
        ...
        <div className="relative animate-fade-up [animation-delay:200ms]">
          <div className="relative aspect-square max-w-lg mx-auto">
            ...
            <img
              src={worldMap}
              alt="pastel world map"
              width={1280}
              height={960}
              className="absolute inset-0 size-full object-cover rounded-[3rem] mix-blend-multiply"
            />
